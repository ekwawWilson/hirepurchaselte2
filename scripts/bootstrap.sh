...
echo "    superadmin@example.test   (SUPER_ADMIN)"
echo "    admin@example.test        (ADMIN)"
echo "    branchmanager@example.test (BRANCH_MANAGER)"
echo "    cashier@example.test      (CASHIER)"
echo "    sales@example.test        (SALES)"
echo "    storekeeper@example.test  (STORE_KEEPER)"
echo "    auditor@example.test      (AUDITOR)"
echo
