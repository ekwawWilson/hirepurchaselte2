...
echo "    superadmin@hplite.test   (SUPER_ADMIN)"
echo "    admin@hplite.test        (ADMIN)"
echo "    branchmanager@hplite.test (BRANCH_MANAGER)"
echo "    cashier@hplite.test      (CASHIER)"
echo "    sales@hplite.test        (SALES)"
echo "    storekeeper@hplite.test  (STORE_KEEPER)"
echo "    auditor@hplite.test      (AUDITOR)"
echo
